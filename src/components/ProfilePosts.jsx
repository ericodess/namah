...
const ProfilePosts = (props) => {
    ...
    const fetchPostData = () => {
        ...
        if(!isHeaderActive){
            ...
            if(isFirstRender === true || props.postAthor !== window.location.hash.split('/')[window.location.hash.split('/').length]){
                        ...
                        return(
                            ...
                            >
                                <Link
                                    ...
                                    to={`/${translatePageType(props.postType)}/post?id=${element.id}&type=${props.postType}`}
                                >
